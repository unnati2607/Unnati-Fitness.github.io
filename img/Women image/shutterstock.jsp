	...
	usi_analytics = {
		...
		usi_app.load = function () {
			...
			try {
				...
				if ((usi_app.is_english || usi_app.is_german_language) && !usi_app.is_existing_customer && usi_app.is_footage_in_cart && !usi_date.is_between('2022-02-21T21:01:00', '2022-02-24T20:59:00')) {
					var language_key = usi_app.get_language_key();
				...
				} else if ((usi_app.is_english || usi_app.is_german_language) && !usi_app.is_existing_customer && usi_app.is_footage_in_cart && usi_date.is_between('2022-02-21T21:01:00', '2022-02-24T20:59:00')) {
					// Sitewide events
					usi_commons.log('[ load ] * * * Load Sitewide Events TT [February] * * *');
